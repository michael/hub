...
module.exports = function () {
  ...
  var defaults = function () {
    ...
    users.findByLogin('admin', function (err, user) {
      if (!user) users.create('admin@substance.io', 'John Admin', 'admin', 'unicornsarecute', function (err, uuid) {
        if (err) throw err;
...
//     users.findByLogin('admin', function (err, user) {
//       if (!user) users.create('admin@substance.io', 'admin', 'unicornsarecute', function (err, uuid) {
//         if (err) throw err;
//         console.log("Created default user");
//       });
//     });
