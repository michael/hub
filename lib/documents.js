...
documents.createBlob = function(docId, blobId, data, cb) {
  db.query(INSERT_BLOB, [docId, blobId, data], function (err, results) {
    return cb(err, !err);
  });
};

documents.getBlob = function(docId, blobId, cb) {
