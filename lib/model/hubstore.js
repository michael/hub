...
HubStore.__prototype__ = function() {
    ...
    this.applyCommand = function(trackId, command, cb) {
      ...
      try {
        ...
        console.log("Hubstore.applyCommand:", "name", name, "doc", docId);
        ...
        if (name === "create") {
          ...
          return documents.get(docId, function(err, doc) {
            if(err) {
              ...
              console.log("HubStore.applyCommand.delete: documents.get, err=", err);
              cb(null);
...
var api = {
  ...
  "getChanges": {
    method: function(args, cb) {
      ...
      new HubStore(args.username).getChanges(args.track, args.last, args.since, cb);
    }
  },
  "getLastChange": {
    method: function(args, cb) {
      //console.log("hubstore getLastChange", args);
      new HubStore(args.username).getLastChange(args.track, cb);
    }
  },
  "applyChange": {
    method: function(args, cb) {
