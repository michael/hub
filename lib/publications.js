...
var BY_DOCUMENT_SQL = 'SELECT * FROM Publications WHERE document = $1',
    ...
    DELETE_PUBLICATIONS_SQL = 'DELETE FROM Publications WHERE document = $1',
...
publications.clear = function (document, callback) {
  db.query(DELETE_PUBLICATIONS_SQL, [document], function(err) {
    db.query(DELETE_DOCUMENT_SQL, [document], callback);
  });
};
